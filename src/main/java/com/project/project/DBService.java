...
public class DBService {
    ...
    public void addUser(String password, String pan, String aadhar, String phone, String name)
    {
        try{
            Class.forName("com.mysql.cj.jdbc.Driver");
            Connection conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/bank", "springUser", "ooadProj@123");
            ...
            String query = "INSERT INTO bank.user(pwduser, panuser, aadharuser, phoneuser, nameuser) VALUES (?,?,?,?,?)";
    ...
    public void addAccount(int account_no, String username, String acctype, double balance)
    {
        try {
            ...
            PreparedStatement stmt = null;
            // System.out.println(password+dob+pan+aadhar+phone+name);
            String query = "INSERT INTO bank.acc_user(accuser, nameuser, acctype, balance) VALUES (?,?,?,?)";
            stmt = conn.prepareStatement(query);
...
public boolean updateBalance(int accountno_1,int accountno_2,double value,String type){
    ...
    PreparedStatement stmt2 = null;
        ...
        if(user_bal<value || user_bal<1000-value){
            ...
            String query1 = "UPDATE acc_user SET balance=? where accuser=? and acctype=?";
            stmt = conn.prepareStatement(query1);
